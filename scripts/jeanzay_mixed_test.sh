#!/bin/bash
#SBATCH --job-name=pubchem32_mixed          # nom du job
#SBATCH --output=logs/pubchem32_mixed.out      # nom du fichier de sortie
#SBATCH --error=logs/pubchem32_mixed.err       # nom du fichier d'erreur (ici commun avec la sortie)
...
srun python -u train.py --run_name pubchem32_mixed --dataset PUBCHEM_32 --config 32_mixed
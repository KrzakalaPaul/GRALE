...
#SBATCH --output=logs/pubchem32_bottleneck_bf16.out      # nom du fichier de sortie
#SBATCH --error=logs/pubchem32_bottleneck_bf16.err       # nom du fichier d'erreur (ici commun avec la sortie)
...
srun python -u train.py --run_name pubchem32_bottleneck_bf16 --dataset_path $SCRATCH/PUBCHEM_32.h5 --config bottleneck/bf16